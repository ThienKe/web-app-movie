...
const quocGia = [{ name: "Hàn Quốc", slug: "han-quoc" }, { name: "Trung Quốc", slug: "trung-quoc" }, { name: "Âu Mỹ", slug: "au-my" }, { name: "Việt Nam", slug: "viet-nam" }, { name: "Nhật Bản", slug: "nhat-ban" }, { name: "Thái Lan", slug: "thai-lan" }, { name: "Ấn Độ", slug: "an-do" }, { name: "Pháp", slug: "phap" }, { name: "Đài Loan", slug: "dai-loan" }, { name: "Hồng Kông", slug: "hong-kong" }, { name: "Anh", slug: "anh" }, { name: "Âu Mỹ", slug: "au-my" }, { name: "Đức", slug: "duc" },  { name: "Nga", slug: "nga" }, { name: "Úc", slug: "uc" },{ name : "Indonesia", slug : "indonesia"} ];
  ...
  return (
    <>
      ...
      <header className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 py-4 px-4 md:px-8 lg:px-12 flex items-center justify-between
        ${scrolled || mobileMenuOpen ? 'bg-black/5 shadow-2xl' : 'bg-transparent'}`}>
          ...
          <div className="hidden md:block relative">
            <form onSubmit={handleSearch} className="relative">
              <input
                ...
                className=" rounded-full px-5 py-2 w-48 lg:w-64 text-white focus:ring-1 focus:ring-red-500 outline-none transition-all"
              />

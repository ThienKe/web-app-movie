        ...
        <div className="min-h-[80vh] flex items-center justify-center text-white p-4">
            <div className="p-8 rounded-2xl w-full max-w-md border border-white/10 shadow-2xl  backdrop-blur-xl">
                ...
                <form onSubmit={onLoginClick} className="flex flex-col gap-6">
                    ...
                    <button
                        disabled={loading}
                        className="bg-blue-600 hover:bg-blue-800 p-3 rounded-xl font-bold transition shadow-lg  flex items-center justify-center gap-2"
                    >
                ...
                <div className="mt-8 text-center">
                    <p className="text-sm text-gray-400">
                        Chưa có tài khoản?{" "}
                        <Link to="/dang-ky" className="text-shadow-blue-700 font-bold hover:text-blue-600 transition-colors underline-offset-4 hover:underline">
                            Tạo tài khoản mới
                        </Link>
                    </p>
                </div>
